  ...
  <div class="container-fluid" id="sun">
    ...
    <div class="row network">
      ...
      <div class="col-6 second">
        <div class="row">
          <div class="col-">
            <textarea name="body" type="text" class="form-control mt-2" id="body" cols="20" rows="5"
              placeholder="whats new!" v-model="editable.body"></textarea>
            <div class="d-flex justify-content-between"></div>
            <form @submit="createPost" class="col-md-3">
